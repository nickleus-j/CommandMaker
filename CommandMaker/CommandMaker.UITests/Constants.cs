namespace CommandMaker.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5001/";
    public readonly static string iOSAppName = "com.companyname.CommandMaker";
    public readonly static string AndroidAppName = "com.companyname.CommandMaker";
